          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Buku & Alat Tulis")}
                onClick={(e) => handleCheckbox(e.target)}
              />
              <span className="ml-2 text-gray-500"> Buku & Alat Tulis </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Elektronik"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Elektronik")}
                onClick={(e) => handleCheckbox(e.target)}
              />
              <span className="ml-2 text-gray-500"> Elektronik </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Fashion Bayi & Anak")}
                onClick={(e) => handleCheckbox(e.target)}
              />
              <span className="ml-2 text-gray-500"> Fashion Bayi & Anak </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Kesehatan"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Kesehatan")}
                onClick={(e) => handleCheckbox(e.target)}
              />
              <span className="ml-2 text-gray-500"> Kesehatan </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                onClick={(e) => handleCheckbox(e.target)}
              />
              <span className="ml-2 text-gray-500">Perawatan & Kecantikan</span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Perlengkapan Rumah")}
                onClick={(e) => handleCheckbox(e.target)}
              />
              <span className="ml-2 text-gray-500"> Perlengkapan Rumah </span>
            </label>
          </li>
        </ul>
